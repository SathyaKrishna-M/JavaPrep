...
const content = {
    ...
    explanationSections: [
        {
            title: 'Introduction: The Bank Vault',
            icon: <FiShield className="w-6 h-6" />,
            content: (
                <div className="space-y-4">
                    <p>
                        <span className="text-blue-400 font-semibold">Encapsulation</span> is about protection.
                        Think of a Class as a <span className="text-cyan-400 font-bold">Bank Vault</span>.
                    </p>
                    <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                        <ul className="list-disc list-inside text-gray-300 space-y-2">
                            <li>
                                <span className="text-yellow-400 font-semibold">Private Data (Money):</span> The gold inside the vault is <span className="text-red-400">private</span>. Random people cannot just walk in and take it.
                            </li>
                            <li>
                                <span className="text-yellow-400 font-semibold">Public Methods (Tellers):</span> To access money, you must go through a <span className="text-green-400">public</span> Teller (method). They verify who you are and if you have enough balance.
                            </li>
                            <li>
                                <span className="text-blue-400 font-semibold">Security:</span> This controlled access prevents theft (invalid data) and chaos.
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        {
            title: 'Access Modifiers (The Security Clearance)',
            icon: <FiEye className="w-6 h-6" />,
            content: (
                <div className="space-y-4">
                    <p className="text-gray-300">
                        Java uses modifiers to determine who is allowed to touch your data.
                    </p>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm text-gray-400 border-collapse border border-gray-700">
                            <thead className="bg-gray-800 text-gray-200">
                                <tr>
                                    <th className="p-2 border border-gray-700">Modifier</th>
                                    <th className="p-2 border border-gray-700">Access Level</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td className="p-2 border border-gray-700 font-mono text-blue-400">public</td>
                                    <td className="p-2 border border-gray-700 text-green-400">Open to the World (The Front Door)</td>
                                </tr>
                                <tr>
                                    <td className="p-2 border border-gray-700 font-mono text-yellow-400">protected</td>
                                    <td className="p-2 border border-gray-700 text-yellow-400">Family & Subclasses (Staff Only)</td>
                                </tr>
                                <tr>
                                    <td className="p-2 border border-gray-700 font-mono text-gray-400">default</td>
                                    <td className="p-2 border border-gray-700 text-gray-400">Package Neighbors (Same Branch)</td>
                                </tr>
                                <tr>
                                    <td className="p-2 border border-gray-700 font-mono text-red-400">private</td>
                                    <td className="p-2 border border-gray-700 text-red-400">Class Only (The Vault itself)</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        {
            title: 'Getters and Setters: The Tellers',
            icon: <FiKey className="w-6 h-6" />,
            content: (
                <div className="space-y-4">
                    <p className="text-gray-300">
                        Why use Getters/Setters instead of public variables? <strong>Control.</strong>
                    </p>
    ...
    exampleProblems: [
        {
            problem: 'Create a fully encapsulated BankAccount class.',
            solution: (
                <div className="space-y-2">
                    <p className="text-gray-300">This example demonstrates:</p>
                    <ul className="list-disc list-inside text-gray-400 text-sm">
                        <li><code className="text-red-400">private</code> fields for security</li>
                        <li>Validation in <code className="text-blue-400">deposit</code> logic</li>
                        <li>Negative balance protection in <code className="text-blue-400">withdraw</code></li>
                    </ul>
                </div>
            ),
            steps: [
                {
                    step: 'Define Private Fields',
                    explanation: 'Hide the balance and account number. They should not be changeable directly from outside.',
                },
                {
                    step: 'Implement Logic',
                    explanation: 'Add checks in withdraw method to prevent overdrafts.',
                },
            ],
