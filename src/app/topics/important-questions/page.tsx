...
import { FiCode, FiBook, FiTarget, FiHelpCircle, FiList } from 'react-icons/fi'

const content = {
  title: 'Important Questions',
  explanationSections: [
    {
      title: 'About Important Questions',
      icon: <FiHelpCircle className="w-6 h-6" />,
      content: `This section contains <span class="text-blue-400 font-semibold">important practice questions</span> covering all major Java programming topics.

These questions are organized by <span class="text-cyan-300">subtopics</span>:
→ <span class="text-cyan-300">I/O Statements</span> - Input/Output operations
→ <span class="text-cyan-300">Conditional Statements</span> - if-else, switch-case
→ <span class="text-cyan-300">Looping Statements</span> - for, while, do-while loops
→ <span class="text-cyan-300">Nested Looping</span> - Nested loop patterns
→ <span class="text-cyan-300">1D Arrays</span> - Single-dimensional arrays
→ <span class="text-cyan-300">2D Arrays</span> - Two-dimensional arrays
→ <span class="text-cyan-300">Methods</span> - Functions and method definitions
→ <span class="text-cyan-300">Recursions</span> - Recursive methods
→ <span class="text-cyan-300">Objects and Classes</span> - OOP concepts

<span class="text-amber-300">Note:</span> All solutions are written in <span class="text-blue-400">Java</span> programming language.`,
    },
  ] as ExplanationSection[],
  exampleCode: `// Example: Hello World Program
